...
import { Button, Form, Input, Radio, Space, Switch, Upload } from 'antd';
...
export const ConfigurationForm = ({ form }: { form: FormInstance }) => {
  ...
  return (
    <Form form={form} name="validateOnly" layout="vertical" autoComplete="off">
      ...
      <Form.Item
        name={['parser_config', 'enable_multimodal_image_retrieval']}
        label={t('enableMultimodalImageRetrieval')}
        tooltip={t('enableMultimodalImageRetrievalTip')}
