...
interface IModelCardProps {
  ...
  clickCustomModel: (llmFactory: string) => void;
}
...
const ModelCard = ({
  ...
  const canAddCustomModel = item.name === LLMFactory.TongYiQianWen;
        ...
        <Row align={'middle'}>
          ...
          <Col span={12} className={styles.factoryOperationWrapper}>
            <Space size={'middle'}>
              ...
              {canAddCustomModel && (
                <Button onClick={handleCustomModelClick}>
                  <Flex align="center" gap={4}>
                    {t('addTheModel')}
                    <SettingOutlined />
                  </Flex>
...
const UserSettingModel = () => {
  ...
  const {
    customModelAddingVisible,
    hideCustomModelAddingModal,
    showCustomModelAddingModal,
    onCustomModelAddingOk,
    customModelAddingLoading,
    selectedCustomModelLlmFactory,
  } = useSubmitCustomModel();
        ...
        <List
          ...
          renderItem={(item) => (
            <ModelCard
              ...
              clickCustomModel={showCustomModelAddingModal}
            ></ModelCard>
          )}
        />
      ),
  ...
  return (
    <section id="xx" className="w-full space-y-6">
      ...
      ></OllamaModal>
      <CustomModelModal
        visible={customModelAddingVisible}
        hideModal={hideCustomModelAddingModal}
        onOk={onCustomModelAddingOk}
        loading={customModelAddingLoading}
        llmFactory={selectedCustomModelLlmFactory}
      ></CustomModelModal>
      <VolcEngineModal
