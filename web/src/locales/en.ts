export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      imageIndexStatus: 'Image index status',
      imageIndexStatusDisabled: 'Disabled',
      imageIndexStatusWaitingForParse: 'Waiting for parsing',
      imageIndexStatusPending: 'Pending build',
      imageIndexStatusReady: 'Ready',
      imageIndexStatusFailed: 'Build failed',
      imageIndexStatusNoFigures: 'No figures',
      imageIndexStatusNoIndexableFigures: 'No indexable figures',
      testingDescription:
...
`,
    ...
    knowledgeConfiguration: {
      ...
      enableMultimodalImageRetrieval: 'Enable image retrieval enhancement',
      enableMultimodalImageRetrievalTip:
        'When enabled, RAGFlow builds a multimodal sidecar index from the exported figures and captions and returns image candidates separately without changing the text retrieval mainline.',
      chunkTokenNumberTip:
