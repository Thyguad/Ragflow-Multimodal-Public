export default {
  translation: {
    ...
    knowledgeDetails: {
      ...
      progressMsg: '进度',
      imageIndexStatus: '图片索引状态',
      imageIndexStatusDisabled: '未开启',
      imageIndexStatusWaitingForParse: '等待解析完成',
      imageIndexStatusPending: '等待构建',
      imageIndexStatusReady: '已就绪',
      imageIndexStatusFailed: '构建失败',
      imageIndexStatusNoFigures: '无图片',
      imageIndexStatusNoIndexableFigures: '无可索引图片',
      testingDescription:
...
`,
    ...
    knowledgeConfiguration: {
      ...
      enableMultimodalImageRetrieval: '开启图片检索增强',
      enableMultimodalImageRetrievalTip:
        '开启后会基于 output 中的图片和图注构建多模态索引，并在对话时返回独立的图片候选，不影响文本检索主链路。',
      chunkTokenNumberTip:
