...
def get_parser_config(chunk_method, parser_config):
    ...
    if not chunk_method:
        chunk_method = "naive"
    multimodal_defaults = {"enable_multimodal_image_retrieval": False}
    key_mapping = {
        "naive": {"chunk_token_num": 128, "delimiter": r"\n", "html4excel": False, "layout_recognize": "DeepDOC", "raptor": {"use_raptor": False}, **multimodal_defaults},
        "qa": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "tag": None,
        "resume": None,
        "manual": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "table": None,
        "paper": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "book": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "laws": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "presentation": {"raptor": {"use_raptor": False}, **multimodal_defaults},
        "one": None,
